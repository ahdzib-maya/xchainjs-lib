...
export const getDefaultClientUrl = (): ClientUrl => {
  return {
    [Network.Testnet]: {
      node: 'https://testnet.mayanode.mayachain.info',
      rpc: 'https://testnet.tendermint.mayachain.info',
    },
    [Network.Stagenet]: {
...
const DEFAULT_EXPLORER_URL = 'https://stagenet.explorer.mayachain.info'
